...
>
> Although an EasyJobTemplating Definition Job encapsulates attributes from the EasyJobTemplating Project, it can also modify them while keeping the core logic define in the Project.
